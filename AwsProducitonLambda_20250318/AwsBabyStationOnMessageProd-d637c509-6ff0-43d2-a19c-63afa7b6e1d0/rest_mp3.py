...
def handle_req_mp3_list_dummy(cur,body):
    ...
    mp3_info_list.append({'slot':3,'ts':1712730628,'del':0})
    mp3_info_list.append({'slot':4,'ts':1669786024,'del':0})
    mp3_info_list.append({'slot':5,'ts':1669786024,'del':0})

    mp3_info_list.append({'slot':8,'ts':1733885580,'del':0})

    mp3_info_list.append({'slot':11,'ts':1733885579,'del':0})
    mp3_info_list.append({'slot':12,'ts':1733885579,'del':0})
    mp3_info_list.append({'slot':13,'ts':1733885579,'del':0})
    mp3_info_list.append({'slot':14,'ts':1733885579,'del':0})
    mp3_info_list.append({'slot':17,'ts':1733885579,'del':0})
    mp3_info_list.append({'slot':19,'ts':1733885579,'del':0})
    mp3_info_list.append({'slot':20,'ts':1733885579,'del':0})
