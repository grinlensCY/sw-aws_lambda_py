...
REQ_CHECK_DFU_HEADER='req_chk_dfu_'

STA_LAST_ALIVE_KEY_HEADER='sta_alive_'
STA_LAST_FW_KEY_HEADER='sta_fw_'

OBS_VAR_KEY_HEADER='obs_var02_'
ODD_SND_RES_KEY_HEADER='odd_snd_res01_'

SLEEP_VAR_KEY_HEADER='slp_var05_'
SLEEP_REQ_COMFORT_KEY_HEADER='slp_level02_'
...
PREF_NOTIFY_ALARM_WAKEUP_KEY_HEADER='notify_alarm_wu_'
...
#redis list op
#redis list op
def list_append(key,dat,timeout=3600):
    ba = json.dumps(dat)
