...
class SleepStatus():
    def __init__(self, udid, age, ver=20240703, scaledSC=True):
        self.ver = ver
        self.imusr = 104
    ...
    def draft_REM(self,vars):
        ...
        if self.age < 4:
            ...
            # self.debugVars['hr_baseline'].extend(copy.deepcopy(vars['hr_baseline']))
            # self.debugVars['rr_baseline'].extend(copy.deepcopy(vars['rr_baseline']))
